...
def UnlimitedTrain_EMS(model, checkpoint_path, data_generator=GenerateTrueData_EMS, ensemble_models=None, ensemble_distributions=None,
                      data_post_process=None, patience=3, data_gen_per_iteration=10000, prop_train=0.8, verbose=False, max_traj_len=200):
    '''
    ...
    while p > 0:
        ...
        Trajs, Labels = data_generator(ensemble_models, ensemble_distributions, N=data_gen_per_iteration, max_traj_len=max_traj_len)
