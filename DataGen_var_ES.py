...
def Gen_Random_Model_Param_Dict(ensemble_distributions, N=100,T=200, L=230.4):
    '''
...
########## MAKE DATASET ##########
def GenerateTrueData_ES(ensemble_distributions, N=10000, return_padding_mask=False, max_traj_len=200):
    '''
    ...
    while True:
        ...
        while True:
            try:
                ...
                FOVs, _, _ = challenge_phenom_dataset(dics=Gen_Random_Model_Param_Dict(ensemble_distributions, N=100), return_timestep_labs=True)
            except:
