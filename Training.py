...
def UnlimitedTrain(model, checkpoint_path, data_generator=GenerateTrueData, data_post_process=None, patience=3, data_gen_per_iteration=10000, prop_train=0.8, verbose=False):
    '''
